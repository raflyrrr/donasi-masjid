...
<head>
    ...
    <title>Register Donatur - Mariberamal</title>
...
<body>
    ...
    <div class="container-fluid" id="background" style="margin-bottom: 12%;">
        <div class="section">
            <?php
            ...
            ?>
                <div class="mt-inner">
                    <div class="col-md-6">
                        <br>
                        <h1 class="text-content font-bold ">Dari kita untuk kita</h1>
                        <br>
                        <h2 class="text-content font-bold font-lg">#ManusiaDermawan </h2>
                        <h2 class="text-content font-bold font-lg">#OrangBaik </h2>
                        <br>
                        <p class="text-content font-md">"Sedekah akan membuka pintu rezeki dari arah yang tidak di sangka sebelumnya"</p>
                        <p class="text-content font-md">"Sedekah tidak sama dengan matematika yang bisa ditambah, dikurang, dibagi dan dikali. Karena sedekah itu akan berlimpah dan berkali-kali lipat kembali kepada kita."</p>
                    </div>
                    <h1 class="font-bold font-l text-left" style="margin-top: 150px">Silahkan Masukan Data Anda</h1>
                    <br>
                    <div class="card-donatur col-md-6">
