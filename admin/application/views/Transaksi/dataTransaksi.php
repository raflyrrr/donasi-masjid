...
<head>
    ...
    <title>Data Transaksi | Mariberamal</title>
                                                ...
                                                <td>
                                                    <center>
                                                        ...
                                                        <span class="spasi">
                                                            ...
                                                            <a href="<?php echo base_url('admin/Transaksi/delete/' . $rows->id_transaksi) ?>" onclick="return confirm('Apakah anda yakin ingin menghapus transaksi ini?');"></span><i class="fa fa-trash fa-lg "></a></i>
                                                    </center>
                                                </td>
                                            </tr>
                                        <?php
